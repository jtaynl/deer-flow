...
export const zhCN: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 WRI AI 的潜力。通过自定义技能，WRI AI\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    voiceInputStart:
      "语音输入。WRI AI 只接收转写文本，音频由浏览器或系统语音服务处理。",
  ...
  backgroundTasks: {
    ...
    cancellationRetrying: (attempt) =>
      `第 ${attempt} 次取消失败；WRI AI 将继续重试。`,
    notificationRetrying: (attempt) =>
      `第 ${attempt} 次聊天通知失败；WRI AI 将退避后重试。`,
    notificationStopped: "聊天通知因反复失败或永久拒绝，已停止重试。",
    trackingDegraded: "状态检查有所延迟，WRI AI 仍在重试。",
    viewDetails: "查看详情",
    hideDetails: "收起详情",
  ...
  scheduledTasks: {
    ...
    context: {
      ...
      reuseNoticeDescription:
        "如果触发时该线程正在运行，WRI AI 会将本次执行排队，并在线程空闲后启动；超过配置的最长等待时间后会标记为失败。",
    },
    search: {
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，WRI AI 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 WRI AI 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  channels: {
    ...
    wechatQr: {
      ...
      saved: "Token 已安全保存",
      savedDescription: "WRI AI 已在服务器保存 Token 并启动微信渠道。",
      bindTitle: "最后一步：绑定你的账号",
      bindDescription:
        "将下方指令发送给微信中的机器人，即可绑定到你的 WRI AI 账号。",
      ...
      login: "扫码连接",
      manual: "使用 Token",
      description: "将微信连接到你的 WRI AI 工作空间。",
      loading: "正在生成二维码…",
      imageTitle: "微信登录二维码",
    ...
    saveChanges: "保存修改",
    descriptions: {
      buzz: "通过 WRI AI 智能体接收 Buzz 频道消息和私聊。",
      telegram: "通过 WRI AI Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 WRI AI Bot 接收 Discord 服务器消息。",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 WRI AI 中使用",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 WRI AI。",
  ...
  settings: {
    ...
    memory: {
      title: "记忆",
      description:
        "WRI AI 会在后台不断从你的对话中自动学习。这些记忆能帮助 WRI AI 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
  ...
  "mcpServers": {
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 WRI AI 发送消息的即时通讯账号。",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "把你的 WRI AI 账号指向另一个 Lark/飞书 App。只影响你自己的账号，不影响其他用户。",
        ...
        authStarted: "授权页已打开，WRI AI 会自动检测授权结果。",
        authorizationStillPending:
          "还没有检测到授权完成。请在浏览器完成授权；WRI AI 会继续自动检测。如果页面没有更新，可点击“我已完成授权”。",
        ...
        openAuthLinkDescription:
          "打开下面的链接完成授权。WRI AI 会持续自动检测，并在授权通过后保存连接状态。",
        waitingAuthTitle: "等待飞书授权完成",
        waitingAuthDescription:
          "请在刚打开的浏览器页面完成授权。WRI AI 会自动更新这里的状态；下方按钮只是兜底操作。",
        openAuthLink: "打开链接",
        copyAuthLink: "复制链接",
        completeAuth: "我已完成授权",
        ...
        authNextDescription:
          "点击“连接飞书”后，WRI AI 会先检查当前状态；未连接或授权过期时会拉起浏览器授权。",
      },
    },
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 WRI AI 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "WRI AI 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，WRI AI 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    rememberMeDescription:
      "下次打开 WRI AI 时尽量保持当前会话，仅保存邮箱，不保存密码。",
    pleaseWait: "请稍候...",
    signIn: "登录",
    createAccount: "创建账号",
