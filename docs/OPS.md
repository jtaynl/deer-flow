...
Most recent upstream sync: **2026-07-28 (later²)** — **6 commits (`88f9f818`→`9a43d827`), CLEAN merge (0 conflicts), 53 files / +3685−223, ⚠ MIGRATION `0009`→`0010_run_cancel_request`.** Merge `e38ec466`. Verified inline (scoped checks — migration read in full, security fix traced to its predicate, cancel gating confirmed in the diff):
