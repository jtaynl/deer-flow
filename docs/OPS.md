...
Most recent upstream sync: **2026-08-02** — **10 commits (`8234370a`→`cd8825b0`), ⚠ 6 CONFLICTS (all our carried WRI landing re-skin vs `#4622`), MIGRATION-FREE (head stays `0010`), 153 files.** Merge `5012a0e0`.
