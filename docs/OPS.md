...
Most recent upstream sync: **2026-08-05** — **12 commits (`bf2cb19c`→`480a3757`), 1 conflict, MIGRATION-FREE (head stays `0010`), 92 files.** Merge `6834965a`. Reviewed by a 12-agent workflow (7 areas, adversarial verify on every HIGH/MEDIUM; 2 findings REFUTED into corrected forms, both mattered).
