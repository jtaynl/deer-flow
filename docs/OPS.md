...
Most recent upstream sync: **2026-07-31** — **4 commits (`0d8e11ad`→`133a82c6`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0010`), 29 files / +1016−140.** Merge `9753bda0`. Verified inline.
