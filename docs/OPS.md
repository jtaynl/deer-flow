...
Most recent upstream sync: **2026-07-03 (later)** absorbed 5 commits — **CLEAN merge** (merge-tree exit 0, zero conflicts — cleanest in a while now the Aio shim is gone)
