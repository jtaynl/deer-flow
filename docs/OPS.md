...
Most recent upstream sync: **2026-07-27 (later)** — **2 commits (`b22f85c6`→`62b73fd2`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0008`), 11 files / +1721−11, backend-only.** Merge `35d5d236`; local `main` marker → `62b73fd2` (**not pushed** — see the fork-auto-sync note above).
