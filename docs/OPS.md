...
Most recent upstream sync: **2026-07-25** — **9 commits (`58befaf2`→`735f67a5`), CLEAN merge (0 conflicts), NO CVE. head `0007`→`0008`.** Merge `6388dcf5`; `main` ff'd → `735f67a5`. Scope: 60 files, +5021/−374. **Runtime/checkpoint robustness; nothing touches our operational path.**
