...
Most recent upstream sync: **2026-07-24 (later)** — **7 commits (`159b7749`→`16b612cf`), CLEAN merge (0 conflicts), NO CVE. head `0006`→`0007`.** Merge `d2096f1b`; `main` ff'd → `16b612cf`. **LOW-RISK — one additive index migration + robustness fixes; nothing touches our operational path.**
