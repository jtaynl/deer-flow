...
Most recent upstream sync: **2026-07-23 (later)** — **12 commits (`70fb9165`→`5f0108f5`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0006`), NO CVE.** Merge `4463714f`; `main` ff'd → `5f0108f5`. **Mostly frontend/gateway/streaming fixes; one auth feature, INERT-by-default.**
