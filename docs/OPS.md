...
Most recent upstream sync: **2026-07-30** — **13 commits (`4582a413`→`0d8e11ad`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0010`), 73 files / +4560−385.** Merge `485a76d7`. Reviewed with a 25-agent risk analysis (15 CONFIRMED / 3 OVERSTATED / 2 UNDERSTATED) **plus a LIVE IMAGE PROBE of the one medium.**
