...
Most recent upstream sync: **2026-07-24** — **6 commits (`959f0527`→`c7538cfb`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0006`), NO CVE.** Merge `15d8d6d0`; `main` ff'd → `c7538cfb`. **LOW-RISK — all robustness/CI fixes, nothing touches our operational path.**
