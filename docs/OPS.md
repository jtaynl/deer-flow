...
Most recent upstream sync: **2026-08-02 (later)** — **2 commits (`cd8825b0`→`c0f1cfef`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0010`), 6 files / +266−29.** Merge `32bed127`. The quietest range in weeks.
