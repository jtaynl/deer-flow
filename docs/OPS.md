...
Most recent upstream sync: **2026-07-23** — **24 commits (`cd862756`→`a38b1dae`), CLEAN merge (0 conflicts), NO CVE. ⚠ FIRST SCHEMA CHANGE SINCE 0005 → head `0005`→`0006`.** Merge `1a1aca80`; `main` ff'd → `a38b1dae`. **This is the batch that was BLOCKED 2026-07-22 by `#4174` and rolled back — NOW UNBLOCKED.**
