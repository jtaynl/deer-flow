...
Most recent upstream sync: **2026-07-21** — **10 commits (`97ca7f88`→`3c0a45ad`), CLEAN merge (0 conflicts), MIGRATION-FREE (head stays `0005`), NO CVE.** Merge `e59af04e`; `main` ff'd → `3c0a45ad`. **LOW-RISK batch — nothing touches our operational path (Aio sandbox / `chat()` / memory / DB schema all unaffected).**
